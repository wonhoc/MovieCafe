...
<body>
	...
	<c:set var="cateNo" value="${param.cateNo }" scope="page" />
		...
		<c:if test="${startPage > pageBlock }">
			<c:url var="prevUrl" value="/board/listBoard_MovieReview.do">
				<c:param name="cateNo" value="${param.cateNo }"></c:param>
		...
		<c:forEach var="i" begin="${startPage}" end="${endPage}">
			...
			<c:if test="${i != currentPage}">
				<c:url var="url" value="/board/listBoard_MovieReview.do">
				<c:param name="cateNo" value="${param.cateNo }"></c:param>
		...
		<c:if test="${endPage < totalPage}">
			<c:url var="nextUrl" value="/board/listBoard_MovieReview.do">
