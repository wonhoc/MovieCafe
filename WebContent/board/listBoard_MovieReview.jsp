		...
		<%-- 페이징 처리 --%>
			...
			<div id="paging">
				...
				<c:if test="${startPage > pageBlock }">
					<c:url var="prevUrl" value="/listBoardMovieReview.do">
						<c:param name="cateNo" value="${param.cateNo }"></c:param>
				...
				<c:forEach var="i" begin="${startPage}" end="${endPage}">
					...
					<c:if test="${i != currentPage}">
						<c:url var="url" value="/listBoardMovieReview.do">
							<c:param name="cateNo" value="${param.cateNo }"></c:param>
				...
				<c:if test="${endPage < totalPage}">
					<c:url var="nextUrl" value="/listBoardMovieReview.do">
			...
			<c:url var="writeUrl" value="/reviewWriteForm.do">
				<c:param name="cateNo" value="${param.cateNo}"></c:param>
			</c:url>
